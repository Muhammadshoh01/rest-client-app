...
export default function VariablePreview({
    ...
    return (
        <div className={`text-xs bg-amber-50 border border-amber-200 rounded p-2 ${className}`}>
            ...
            <div className="space-y-1">
                ...
                <div className="text-gray-800">
                    ...
                    <code className={`px-1 py-0.5 rounded ml-1 text-xs break-all ${hasUnresolvedVars ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'
                        }`}>
                        {resolved}
                    </code>
                </div>
